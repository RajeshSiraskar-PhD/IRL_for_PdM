...
\begin{figure}
	\begin{floatrow}
		...
		\ffigbox{%
			\centering
			\includegraphics[width=0.9\linewidth]{images/SRL_Articles_funnel.png}
		}{
		\caption{Articles across databases.\\(\textcolor{blue}{Blue} numbers from Table \ref{tbl:SLR}).}\label{fig:SLR}}
		\end{floatrow}%
\end{figure}
...
\texttt{("Inverse Reinforcement Learning" OR "Imitation Learning" OR "Apprenticeship Learning") AND ("robot")} Scopus: 1,194  results, WOS 1,378
