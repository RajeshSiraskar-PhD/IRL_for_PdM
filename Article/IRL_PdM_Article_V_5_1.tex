...
\begin{document}
	...
	Our goal is to generate a predictive maintenance \textit{policy} $\pi$, that reproduces the expertise of the predictive maintenance engineer, given by \ref{eq:pi}.
